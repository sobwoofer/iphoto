...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Blog | Minimalio - Personal / Portfolio Minimal Template</title>
					...
					<div class="col-md-8 col-sm-8 col-xs-12">
						<div class="minimalio-blog-describe-section">
							<div class="minimalio-blog-img">
								<img src="http://via.placeholder.com/700x250" alt="Blog Post Image">
								<p>FEB 04, 2017 </p>
							</div> <!-- end minimalio-blog-img -->
							<div class="minimalio-blog-content">
								<h2>FULL WIDTH BLOG POST</h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur ea, quis magnam deserunt eius incidunt repellat molestiae maiores, quidem consequuntur ea, quis magnam deserunt eius incidunt a  repellat molestiae maiores, quidem cumque!</p>
							...
							<div class="row minimalio-blog-comments-readmore">
								...
								<div class="col-md-6 col-sm-6 col-xs-12 minimalio-blog-readmore">
									<a href="single-blog.blade.php" target="_self">Read More</a>
								</div>
						...
						<div class="minimalio-blog-describe-section">
							...
							<div class="row minimalio-blog-comments-readmore">
								<div class="col-md-6 minimalio-blog-comments">
									<ul>
										<li><a href="#"><i class="fa fa-refresh"></i></a></li>
										<li><a href="#"><i class="fa fa-comment-o"></i></a></li>
										<li><a href="#"><i class="fa fa-heart"></i></a></li>
									</ul>
								</div>	<!-- end minimalio-blog-comments -->
								<div class="col-md-6 minimalio-blog-readmore">
									<a href="single-blog.blade.php" target="_self">Read More</a>
								</div>
							</div>	<!-- end row and minimalio-blog-comments -->
						</div> <!-- end minimalio-blog-img -->
