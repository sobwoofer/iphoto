...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>About | Minimalio - Personal / Portfolio Minimal Template</title>
	...
	<body>
				                ...
				                <div class="minimalio-overlay" id="minimalio-overlay-id">
				                    <nav class="minimalio-overlay-menu">
				                        <ul>
											...
											<li><a href="single-blog.blade.php" target="_self">Blog Single</a></li>
		...
		<div class="minimalio-about-bottom-image">
			<a class="video-popup" href="https://vimeo.com/175629655">
				<img src="http://via.placeholder.com/1500x650" alt="iMac PC Image on a Table">
			</a>
