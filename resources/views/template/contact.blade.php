...
<!--<![endif]-->
	<head>
		<meta charset="UTF-8">
		<title>Contact | Minimalio - Personal / Portfolio Minimal Template</title>
	    ...
	    <!--[if lt IE 9]> 
	        <script src="/vendor/template/js/html5shiv.js"></script>
	        <script src="/vendor/template/js/respond.js"></script>
	    <![endif]-->

		<!-- noJS CSS -->
	    <noscript><link rel="stylesheet" type="text/css" href="/vendor/template/css/noJS.css"/></noscript>
	    <!-- Modernizr custom js -->
